      ...
      <main>
        <div className="">
          ...
          <div id="main-content" className="w-[100vw] h-[100vh] flex flex-col items-center justify-center">
            ...
            {!imageLoaded && <p className="text-white text-xl">Loading...</p>}
            <button className="bg-white text-black px-4 py-2 rounded-md hover:bg-gray-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300" disabled={loading} onClick={generateImage}>Generate a cat 🐱</button>
          </div>
        </div>
      </main>
